...
class Beneficiary(models.Model):
    ...
    dni = models.CharField('ci',max_length=8)
#     photo = models.ImageField('foto',upload_to='beneficiaries')
    ...
    m_code = models.CharField('matricula',max_length=10)
    blood_group = models.CharField('grupo sanguineo',max_length=3)
    is_active = models.BooleanField('activo',default=True)
    type_beneficiary = models.ForeignKey(TypeBeneficiary,on_delete=models.CASCADE)
    beneficiary_d = models.ForeignKey('self',on_delete=models.CASCADE,blank=True,null=True)
